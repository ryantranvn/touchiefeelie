...
(function ($) {
    $.fn.EasyTree = function (options) {
        ...
        var iconDefault = defaults.iconDefault;
        var iconClose = defaults.iconClose;
        var iconOpen = defaults.iconOpen;
        this.each(function () {
            var easyTree = $(this);
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(this).find(' > span > span').addClass(iconOpen);
                    ...
                    text = $(this).text();
                    $(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0);"></a> </span>');
                    $(this).find(' > span > span').addClass(iconDefault);
                    $(this).find(' > span > a').text(text);
                }
            });
                    ...
                    $(createInput).find('.confirm').click(function () {
                        ...
                        if (selected.length <= 0) {
                            ...
                            if ($(selected).hasClass('parent_li')) {
                                ...
                                $(selected).addClass('parent_li').find(' > span > span').addClass(iconOpen).removeClass(iconDefault);
                    ...
                    if (selected.length <= 0) {
                        ...
                        $(easyTree).find('.alert .alert-content .confirm').on('click', function () {
                            ...
                            if($(selected).parent('ul').find(' > li').length <= 1) {
                                $(selected).parents('li').removeClass('parent_li').find(' > span > span').removeClass(iconOpen).addClass(iconDefault);
