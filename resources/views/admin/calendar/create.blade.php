...
@section('action')
	<div class="row">
		<div class="col-sm-12">
			<form id="frmCalendar" action="{{ url('/'.ADMIN.'/'.$controller) }}" method="POST">
				{{ csrf_field() }}
                {{ method_field('POST') }}
				...
				<div class="row">
                	<div class="col-sm-12 col-md-3">
						...
						<div class="form-group">
							...
							<div class="form-line">
								<input type="text" name="number_days" class="form-control positive-number" />
							</div>
						</div>
					</div>
                	...
                	<div class="col-sm-12 col-md-2">
						<div class="form-group btn-multi-select-wrap btn-days-wrap">
							...
							<div class="btn-wrap">
								<button class="btn btn-select" data-value="{{ $key }}">{{ $day }}</button>
